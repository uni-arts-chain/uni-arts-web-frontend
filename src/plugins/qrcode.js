...
var qrcode = (function () {
    var r = function (r, t) {
        var e = r,
            ...
            s = function () {
                for (
                    var r = y.getPatternPosition(e), t = 0;
                    t < r.length;
                    t += 1
                )
            ...
            d = function (r, t) {
                for (
                    var e = (n << 3) | t, a = y.getBCHTypeInfo(e), u = 0;
                    u < 15;
                    u += 1
                ) {
                    var f = !r && 1 == ((a >> u) & 1);
            ...
            p = function (r, t, e) {
                for (
                    var n = C.getRSBlocks(r, t), o = A(), i = 0;
                    i < e.length;
                    i += 1
                ) {
                    var a = e[i];
                    o.put(a.getMode(), 4),
                        o.put(a.getLength(), y.getLengthInBits(a.getMode(), r)),
                        a.write(o);
                }
                var u = 0;
                ...
                return (function (r, t) {
                    for (
                        ...
                        for (var g = 0; g < i[u].length; g += 1)
                            i[u][g] = 255 & r.getBuffer()[g + e];
                        e += f;
                        var h = y.getErrorCorrectPolynomial(c),
                            l = B(i[u], h.getLength() - 1).mod(h);
                        for (
                            a[u] = new Array(h.getLength() - 1), g = 0;
                            g < a[u].length;
                            g += 1
                        ) {
                            var s = g + l.getLength() - a[u].length;
                            a[u][g] = s >= 0 ? l.getAt(s) : 0;
                        }
                    }
                    var v = 0;
        ...
        (c.addData = function (r, t) {
            ...
            (c.make = function () {
                if (e < 1) {
                    for (var r = 1; r < 40; r++) {
                        for (
                            var t = C.getRSBlocks(r, n), o = A(), i = 0;
                            i < u.length;
                            i++
                        ) {
                            var a = u[i];
            ...
            (c.createSvgTag = function (r, t) {
                var e = {};
                "object" == typeof arguments[0] &&
                    ((r = (e = arguments[0]).cellSize), (t = e.margin)),
                    (r = r || 2),
                    (t = void 0 === t ? 4 * r : t);
                var n,
                    o,
                    i,
                    a,
                    u = c.getModuleCount() * r + 2 * t,
                    f = "";
                for (
                    a = "l" + r + ",0 0," + r + " -" + r + ",0 0,-" + r + "z ",
                        f +=
                    ...
                    for (i = o * r + t, n = 0; n < c.getModuleCount(); n += 1)
                        c.isDark(o, n) &&
                            (f += "M" + (n * r + t) + "," + i + a);
                return (
            ...
            (c.createImgTag = function (r, t, e) {
                (r = r || 2), (t = void 0 === t ? 4 * r : t);
                var n = c.getModuleCount() * r + 2 * t,
                    o = "";
                return (
                    (o += "<img"),
                    (o += ' src="'),
                    (o += c.createDataURL(r, t)),
                    (o += '"'),
                    (o += ' width="'),
                    (o += n),
                    (o += '"'),
        ...
        return (
                            ...
                            for (
                                ...
                                (i = "█"),
                                    u <= e &&
                                        ...
                                        u <= t &&
                                        t < f &&
                                        c.isDark(n, Math.floor((e - u) / 1)) &&
                                        (i = " "),
                                    u <= e &&
                                    e < f &&
                                    u <= t + 1 &&
                                    t + 1 < f &&
                                    c.isDark(o, Math.floor((e - u) / 1))
                                        ? (i += " ")
                                        : (i += "█"),
                                    (l += r < 1 && t + 1 >= f ? h[i] : g[i]);
                            l += "\n";
            ...
            (c.renderTo2dContext = function (r, t) {
                t = t || 2;
                for (var e = c.getModuleCount(), n = 0; n < e; n++)
                    for (var o = 0; o < e; o++)
                        (r.fillStyle = c.isDark(n, o) ? "black" : "white"),
    ...
    var t,
        ...
        y =
            ...
            (e.getLostPoint = function (r) {
                ...
                var g = 0;
                for (o = 0; o < t; o += 1)
                    for (n = 0; n < t; n += 1) r.isDark(n, o) && (g += 1);
                return (e += (Math.abs((100 * g) / t / t - 50) / 5) * 10);
            }),
            e),
        p = (function () {
            for (
                ...
                multiply: function (r) {
                    for (
                        ...
                        for (var o = 0; o < r.getLength(); o += 1)
                            t[e + o] ^= p.gexp(
                                p.glog(n.getAt(e)) + p.glog(r.getAt(o))
                            );
                    return B(t, 0);
                },
                mod: function (r) {
                    ...
                    for (
                        var t = p.glog(n.getAt(0)) - p.glog(r.getAt(0)),
    ...
    var C = (function () {
        ...
        S = function (r, t, e) {
            for (
                ...
                for (var i = 0; i < r; i += 1) n.setPixel(i, o, e(i, o));
            var a = L();
            n.write(a);
            for (
                var u,
